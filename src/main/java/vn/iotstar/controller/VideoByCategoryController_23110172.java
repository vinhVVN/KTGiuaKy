...
public class VideoByCategoryController_23110172 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (idStr == null) {
            ...
            List<Category_23110172> allCategories = cateService.findAllWithVideos();
            ...
            List<Video_23110172> videos = videoService.findByCategoryId(cateId);
            Category_23110172 category = cateService.findById(cateId);
            
            // Để tái sử dụng view, ta add category đơn lẻ này vào 1 list
            category.setVideos(videos); // Gán list video vào đối tượng category
            List<Category_23110172> singleCateList = new ArrayList<>();
